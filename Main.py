...
font2 = tkFont.Font(family='Lato Medium', size=18, ) #czcionka HN T 23
...
w.create_rectangle(0, 0, 800, 600, fill="#FAFAFA", width=0) #gorne tlo
w.create_rectangle(0, 0, 800, 130, fill="#00AAE3", width=0) #gorne tlo

interface.interface1(root, w) #zaladowanie karty Aktualnosci
intro() #zaladowanie 3 sekundowego intro

menu3 = w.create_text(457, 98, anchor=NW, text="Moje dane", font=font2, activefill="#D8D8D8", fill="#ffffff")

menu4 = w.create_text(632, 98, anchor=NW, text="Ustawienia", font=font2, activefill="#D8D8D8", fill="#ffffff")

menu1 = w.create_text(80, 98, anchor=NW, text="Aktualnosci", font=font2, activefill="#D8D8D8", fill="#ffffff")

menu2 = w.create_text(264, 98, anchor=NW, text="Moj dziennik", font=font2, activefill="#D8D8D8", fill="#ffffff")
